            ...
            _createClass(Manager, [
              ...
              },
              {
                ...
                value: function onopen() {
                  ...
                  var socket = this.engine;
                  this.subs.push(
                    on_1.on(socket, "ping", this.onping.bind(this)),
                    on_1.on(socket, "data", this.ondata.bind(this)),
                    on_1.on(socket, "error", this.onerror.bind(this)),
                    on_1.on(socket, "close", this.onclose.bind(this)),
                    on_1.on(this.decoder, "decoded", this.ondecoded.bind(this))
                  );
                },
                /**
                 * Called upon a ping.
            ...
            _createClass(StrictEventEmitter, [
              {
                ...
                value: function on(ev, listener) {
                  _get(
                    _getPrototypeOf(StrictEventEmitter.prototype),
                    "on",
                    this
              ...
              },
              {
                ...
                value: function emit(ev) {
                  ...
                  (_get2 = _get(
                    ...
                    "emit",
                    this
                  )).call.apply(_get2, [this, ev].concat(args));
              ...
              },
              {
                ...
                value: function emitReserved(ev) {
                  ...
                  (_get3 = _get(
                    ...
                    "emit",
                    this
                  )).call.apply(_get3, [this, ev].concat(args));
